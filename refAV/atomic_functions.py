...
def get_objects_of_category(log_dir, category)->dict:
    ...
    """
    categories=["REGULAR_VEHICLE","PEDESTRIAN","BOLLARD","CONSTRUCTION_CONE","CONSTRUCTION_BARREL","STOP_SIGN","BICYCLE","LARGE_VEHICLE","WHEELED_DEVICE","BUS","BOX_TRUCK","SIGN","TRUCK","MOTORCYCLE","BICYCLIST","VEHICULAR_TRAILER","TRUCK_CAB","MOTORCYCLIST","DOG","SCHOOL_BUS","WHEELED_RIDER","STROLLER","ARTICULATED_BUS","MESSAGE_BOARD_TRAILER","MOBILE_PEDESTRIAN_SIGN","WHEELCHAIR","RAILED_VEHICLE","OFFICIAL_SIGNALER","TRAFFIC_LIGHT_TRAILER","ANIMAL","EGO_VEHICLE","VEHICLE","ANY"]
    if category not in categories:
        raise ValueError(f"错误：'{category}' 不在类别列表 {categories} 中")
    else:
